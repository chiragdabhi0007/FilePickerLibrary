        ...
        view?.let {
            ...
            if (photoGridAdapter == null) {
                context?.let {
                    ...
                    photoGridAdapter = FolderGridAdapter(it, mGlideRequestManager, dirs, mutableListOf(), PickerManager.isEnableCamera)
